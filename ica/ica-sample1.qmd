...
*About 90 percent of the cities were warmer than normal*

  - How did this goal inform what information is displayed in the visualization?
*the actual temperature is both higher and lower than the normal range*


**Aesthetic Mapping** 

- What specific variables (from the data codebook) underlie the visualization?
`Low`/`High`, `NormalLow`/`NormalHigh`, `Month`, PrecipYr
...
ggplot(weather, aes(x = dateInYear, y = CulmPrec, group = Month)) +
  geom_area(
    fill = "#ebeae2",
    color = NA
  ) +
